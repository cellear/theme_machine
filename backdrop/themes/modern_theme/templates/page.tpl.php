...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header"><div class="section">
		...
		<?php if (theme_get_setting('social_links', 'modern_theme')): ?>
          <div class="social-icons">
           <ul>
            <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'modern_theme') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
            <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'modern_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'modern_theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
            <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'modern_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'modern_theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
           </ul>
          </div>
        <?php endif; ?>
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix">
	...
	<div id="footer-wrapper"><div class="section">
		...
		<div id="developed" style="text-align: right"><?php print t('Designed by '); ?>  <a href="http://www.zymphonies.com/">Zymphonies</a>
